...
export class Events {
  ...
  static start(e) {
    ...
    let {
      ...
      func,
      arg
    } = Events.findEvent(Events.eventsType.start);
  ...
  static move(e) {
    ...
    let {
      ...
      func,
      arg
    } = Events.findEvent(Events.eventsType.drag);
  ...
  static tap(e) {
    let {
      ...
      func,
      arg
    } = Events.findEvent(Events.eventsType.tap);
  ...
  static longTap(e) {
    ...
    let {
      ...
      func,
      arg
    } = Events.findEvent(Events.eventsType.longtap);
