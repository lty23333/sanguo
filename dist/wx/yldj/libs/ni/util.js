export default class Util {
   ...
   */
  static limitSort(arr, key, downup) {
    arr.sort((a, b) => {
      return (a - b) * downup;
    });
  }
  ...
  static getObjsValueToArr(list, key) {
    let c = [];
  ...
  static checkObjHasValue(obj, arr) {
  ...
  static checkValueInString(arr, s) {
